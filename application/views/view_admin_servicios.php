...
<html lang="en">
  ...
  <body>
    <h1 style=" text-align: center;  margin-top: 50px; margin-bottom: 50px;">Administracion de servicios del Hotel</h1>
    <table class="table table-hover table-dark">
      ...
      <tbody>
        <?php
        if (!empty($servi)) {
          foreach ($servi as $fila) {

            ?>
            <tr>
              <th scope="row"><?php echo $fila->id; ?></th>
              <td><?php echo $fila->nombre_servicio; ?></td>
              <td><?php echo $fila->codigo_servicio; ?></td>
